      ...
      <div id="wd-lab1">
        ...
        <div id="wd-p-tag">
          ...
          <p id="wd-p-3">
            ...
            above and this paragraph, by default, browsers render them as one contiguous piece of text.
          </p>
          <p id="wd-p-4">
        ...
        <div id="wd-lists">
          ...
          My favorite recipe:
          <ol id="wd-ackee-n-saltfish">
            <li>Boil the saltfish twice.</li>
            <li>Add the seasoning to a saucepan.</li>
            <li>Add the boiled saltfish to the pan.</li>
            <li>Add the ackee on low fire and cook for 10 minutes.</li>
            <li>Serve with boiled or fried food.</li>
          </ol>
        ...
        <div id="wd-forms">
          ...
          <form id="wd-text-fields">
            ...
            <h5>Radio Buttons</h5>
            <label htmlFor="wd-radio-genre">Favorite movie genre:</label>
            <br />
                <input type="radio" name="radio-genre" id="wd-radio-comedy" />      {/* set name attribute to same value for mutually exclusive buttons*/}
            ...
            <h5>Checkboxes</h5>
            <label htmlFor="wd-chkbox-genre">Favorite movie genre:</label>
            <br />
            ...
            <label htmlFor="wd-text-fields-email">Email:</label>
                <input type="email" placeholder="webdev-jose@somewhere.com" id="wd-text-fields-email" /><br />
